<html>
    ...
    <body class="container">
        ...
        <form action='".$_SERVER["PHP_SELF"]."' method='post'>
            ...
            <div class='row columna'>
                 <label for='Fecha' class='titulo col-md-2 offset-md-3'>Fecha Nacimiento:</label><input name='nacimiento' type='text' value='".$usuario[2]."' class='col-md-3 infoP'>
            </div>
            <div class='row columna'>
            ...
            <div class='row columna'>
             ...
             <div class='row columna'>
                 <label for='Direccion' class='titulo col-md-2 offset-md-3'>Dirección:</label><input type='text'  name='direccion' value='".$usuario[5]."' class='col-md-3 infoP'>
             </div>
             <div class='row columna'>
                <label for='Cargo' class='titulo col-md-2 offset-md-3'>Cargo:</label>"; if($_SESSION["Tipo"]=="Profesor"){echo "<input name='cargo' type='text' id='cargo' class='col-md-3 sinEscritura' readonly value='".$usuario[6]."'></input>";}else if($_SESSION["Tipo"]=="Admin"){echo "<input name='cargo' type='text' class='col-md-3 infoP' value='".$usuario[6]."'></input>";}
            echo"</div>
             </div>
             <div class='columna'>
                 <div class='row'>
        ...
        if(isset($_GET["me"])){
                    $mensaje=$_GET["me"];
                    if($mensaje=="Si"){
                    echo"<script type='text/javascript'>alert('Información guardada satisfactoriamente'); </script>";
                    }else{
                        echo"<script type='text/javascript'>alert('No se ha podido guardar la información'); </script>";
                    }
                }
        ?>
